...
<html lang="en">
	...
	<body>
		...
		<main>
			...
			<h2>Use Case</h2>
			<p>Rafael needs to let the ProductHunt community know that he is ready to show the world his app MVP and to get their feedback to enhance his app. He logs into PH and clicks on the + in the upper right corner. He enters his apps URL manually, because he's typed it into his Chrome browser too many times to count, and hits the 'next' button. On the next page of the form Rafael types in the name of his app, 'Spin the Digital Bottle'. He presses tab to move to the next field and enters his tagline, 'The digital bottle everyone is dying to spin. Who will you land on next?'. He then chooses the 'Games' drop down menu item for the category of his app. Rafael really wants to be visible to all the PH users, so he's already planned out what topic tags he will use, based on his interaction on PH the past few months. He enters, 'digital makeout session, teenage angst games, If only I got to play REAL spin the bottle with Karen *tear*...'. Rafael then sets the status of his post to 'Available Now' and clicks the 'next' button. Rafael then uploads a thumbnail image from his computer, and a few gallery screenshots to showcase all the best features of his app. He then clicks the 'next' button once again. Finally, on the last page of the form, Rafael enters his ProductHunt handle to the 'Makers' form field to make it official, and then quickly clicks the 'submit' button with a sigh of relief.</p>
